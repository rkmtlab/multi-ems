...
void channelWrite(){
  ...
  //this must be update for individual controls of durations
  for(int t=0; t< ( ((channels[0].getDuration()*1000)+2000) / (1000/channels[0].getFrequency()) ) ;t++){
